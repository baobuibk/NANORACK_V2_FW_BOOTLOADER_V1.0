...
#define FIRMWARE_SAVE					 FLASH_SECTOR1_BASE_ADDRESS
#define FIRMWARE_SAVE_SECTOR			 FLASH_SECTOR_1
#define FIRMWARE1_ADDRESS  			     FLASH_SECTOR2_BASE_ADDRESS
#define FIRMWARE2_ADDRESS  			     FLASH_SECTOR8_BASE_ADDRESS
#define FIRMWARE1_SECTOR      			 FLASH_SECTOR_2  // Sector đầu của Firmware 1
#define FIRMWARE2_SECTOR    			 FLASH_SECTOR_8  // Sector đầu của Firmware 2
#define FW1_NUM_SECTORS     			 6  // Số sector firmware 1 chiếm
